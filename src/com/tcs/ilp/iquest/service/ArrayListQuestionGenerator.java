...
import questiongenerator.Qgenerate;
...
public class ArrayListQuestionGenerator extends QuestionGenerator {
	 ...
	 */
	public Map<String, String> createTemplate(String concept, String source, int noOfQuestions, String empId,
			HashMap<String, ArrayList<EntityMapping>> fieldMap, ArrayList<EntityMapping> mapList, 
			String methodName1, String methodDetails1, String methodName2, String methodDetails2,int loop) {
	...
	//	Qgenaratebean q = new Qgenaratebean();
	//noOfQuestionsToGenerate = que.getNoOfQuestions();
		
//		System.out.println("array  "+noOfQuestionsToGenerate);

		//	noOfQuestionsToGenerate = 50; // This will come from UI. Value should be > 0
//	noOfQuestionsToGenerate = q.getNoOfQuestions();
